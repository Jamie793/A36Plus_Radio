...
{
    gpio_mode_set(BK4819_GPIO_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, BK4819_GPIO_SCK_PIN | BK4819_GPIO_SDA_PIN);
    gpio_output_options_set(BK4819_GPIO_PORT, GPIO_OTYPE_OD, GPIO_OSPEED_50MHZ, BK4819_GPIO_SCK_PIN | BK4819_GPIO_SDA_PIN);
